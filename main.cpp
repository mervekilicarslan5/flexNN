...
/* }); */
    ...
    /* auto test_X = read_mnist(cfg.data_dir,"MNIST-test-images-idx3-ubyte", n_test); */
    /* auto test_Y = read_mnist_label(cfg.data_dir,"MNIST_t10k-labels.idx1-ubyte", n_test); */
    /* auto test_X = read_custom_images("./dataset/MNIST_t10k-images.bin", n_test, ch, h, w); */
    /* auto test_Y = read_custom_labels("./dataset/MNIST_t10k-labels.bin", n_test); */
    /* auto test_X = read_mnist(cfg.data_dir, "MNIST_t10k-images.idx3-ubyte", n_test); */
    /* auto test_Y = read_mnist_label(cfg.data_dir, "MNIST_t10k-labels.idx1-ubyte", n_test); */
    /* auto [test_X, test_YX] = read_cifar10_file("./dataset/CIFARt10k-images.idx3-ubyte",n_test); */
	/* auto test_Y = read_mnist_label(cfg.data_dir, "t10k-labels.idx1-ubyte", n_test); */

    /* auto test_X = read_cifar10_images("./dataset/CIFARt10k-images.idx3-ubyte", n_test); */
	/* auto test_Y = read_cifar10_labels("./dataset/CIFAR-t10k-labels.idx1-ubyte", n_test); */
...
/* 	int n_train = 60000, n_test = 300, ch = 3, h = 224, w = 224, num_classes = 10; */
...
/*     auto test_X = read_cifar10_images("./dataset/CIFARt10k-images.idx3-ubyte", n_test); */
/* 	auto test_Y = read_cifar10_labels("./dataset/CIFAR-t10k-labels.idx1-ubyte", n_test); */
/*     /1* auto test_X = read_dummy_image(n_test, h, w, ch); *1/ */
/*     /1* auto test_Y = read_dummy_label(n_test, num_classes); *1/ */
...
/*         std::cout << "Loading Model Parameters..." << std::endl; */
/*         model.load(cfg.save_dir, cfg.pretrained); */
/*         /1* model.load(cfg.save_dir, "dummy"); *1/ */
/*         model.evaluate(test_loader); */
/*     /1* } *1/ */
